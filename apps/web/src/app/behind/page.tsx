...
export const metadata = {
  ...
  description: "The stores, the incidents, and every pin we do not fully believe.",
};

/**
 * The machinery, one click off the front page.
 *
 * It is here rather than on `/` because a shopper does not care about a
 * scraper's null rate, and it is not buried because the fleet is the reason to
 * believe the prices. Rails are fetched across core and stretch here, not just core: a
...
export default async function BehindPage() {
  // The fleet is fetched for the two provenance numbers -- how many stores
  // contribute and how many rows the last pull returned.
