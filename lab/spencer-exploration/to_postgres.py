...
Usage:
    uv run lab/spencer-exploration/to_postgres.py --dry-run
    uv run lab/spencer-exploration/to_postgres.py --url postgres://...
    uv run lab/spencer-exploration/to_postgres.py --verify --url postgres://...
