...
**PASS** - 6 PH site(s) reached `fleet_ready`; the bar in `docs/prd.md` section 2 is 2.
...
- **S&R Membership Shopping** (`ph-snr`) - score 73, server_rendered via unlocker, 3/10 basket categories present
  - evidence: https://www.snrshopping.com/product/new-arrival/nescafe-gold-instant-coffee-190g
...
124 candidates probed. US fleet-ready **17**, PH fleet-ready **6**.
...
| 94 | US | WebstaurantStore | `us-webstaurant` | server_rendered | direct | json-ld | 8/10 | bread, chicken, coffee, cooking_oil, eggs, milk, pasta, rice |
...
| 73 | PH | S&R Membership Shopping | `ph-snr` | server_rendered | unlocker | json-ld | 3/10 | chicken, coffee, rice |
...
Structural spread across the fleet-ready set: json-ld 13, spa-with-state 4, microdata 2, unknown 2, bare-html 2.
...
| 77 | US | Save Mart | `us-savemart` | server_rendered | direct | spa-with-state | 1/10 | eggs |
...
| 71 | PH | The Generics Pharmacy | `ph-tgp` | server_rendered | unlocker | json-ld | 1/10 | sugar |
...
| 59 | US | Walgreens | `us-walgreens` | server_rendered | unlocker | bare-html | 0/10 | - |
...
| 55 | PH | Lazada PH | `ph-lazada` | server_rendered | unlocker | bare-html | 0/10 | - |
...
| 53 | PH | The Marketplace by Rustan's | `ph-rustans` | spa_empty | unlocker | spa-with-state | 0/10 | - |
